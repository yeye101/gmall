...
public class SkuSaleAttrValueController {
   ...
   * @return
   */
  @RequestMapping("/saleattrlist/{skuId}")
  public R querySaleAttrListById(@PathVariable("skuId") Long skuId) {
    List<String> saleAttrList = skuSaleAttrValueService.querySaleAttrListById(skuId);
